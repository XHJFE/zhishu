...
module.exports = function (params, cb) {
    ...
    let keys = ['menus', 'cities', 'baseInfo', 'viewNum', 'profession', 'nearHouseEsf', 'nearHouseZf', 'nearStress', 'upList', 'hotList', 'hotStress'];
    let getDefaultArea = proxyHouse.getDefaultArea();
    ...
    getDefaultArea.then(function (data) {
        ...
        cityInfo.then(function (cityInfoData) {
            ...
            let hotStress = proxyHouse.getHotStress(sqid);

            Promise.all([menus, cities, baseInfo, viewNum, profession, nearHouseEsf, nearHouseZf, nearStress, upList, hotList, hotStress]).then(function (result) {
