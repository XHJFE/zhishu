...
module.exports = function (params, cb) {
    ...
    let keys = ['menus', 'cities', 'baseInfo', 'cityInfo', 'cityUpList', 'cityDownList', 'hotList', 'viewNum'];
    ...
    Promise.all([menus, cities, baseInfo, cityInfo, cityUpList, cityDownList, hotList, viewNum]).then(function (result) {
